...
export default function AppItem({ app }) {
    ...
    return <div className="m-4 p-4 dark:bg-green-800 dark:text-gray-100 bg-green-100 text-gray-600 rounded">
        <Link href={'https://play.google.com/store/apps/details?id=' + app.appId} 
            className="font-bold text-lg">{app.title}</Link>
        <p className="w-5/6 h-20 mb-4 overflow-hidden hover:overflow-auto">
            {app.description}
        </p>
        <div>
            {images}
